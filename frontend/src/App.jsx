        ...
        function App() {
            ...
            const loadNews = async () => {
                try {
                    ...
                    speak(`Đã tải ${data.articles.length} bài báo từ VnExpress. Nói "đọc" để nghe bài đầu tiên.`)
                } catch (err) {
            ...
            const readCurrentArticle = () => {
                ...
                let dateInfo = article.metadata && article.metadata.date ? `. ${article.metadata.date}` : ""
            ...
            return (
                <div className="app-container">
                    <header className="app-header">
                        <h1>Ứng Dụng Đọc Tin Tức VnExpress</h1>
